...
export class FindingBase implements ILanguageBase {
    ...
    private readonly _language: Language = new Language("Finding", "0.1", "FindingLanguage", "FindingLanguage");
    ...
    private readonly _Finding_severity = new Property(this._Finding, "severity", "Finding-severity", "Finding-severity").isOptional();
    get Finding_severity(): Property {
        this.ensureWiredUp();
        return this._Finding_severity;
    }
    private readonly _Finding_message = new Property(this._Finding, "message", "Finding-message", "Finding-message").isOptional();
    get Finding_message(): Property {
        this.ensureWiredUp();
        return this._Finding_message;
    }
    private readonly _Finding_code = new Property(this._Finding, "code", "Finding-code", "Finding-code").isOptional();
    ...
    private readonly _Severity_info = new EnumerationLiteral(this._Severity, "info", "Severity-info", "Severity-info");
    get Severity_info(): EnumerationLiteral {
        this.ensureWiredUp();
        return this._Severity_info;
    }
    private readonly _Severity_warning = new EnumerationLiteral(this._Severity, "warning", "Severity-warning", "Severity-warning");
    get Severity_warning(): EnumerationLiteral {
        this.ensureWiredUp();
        return this._Severity_warning;
    }
    private readonly _Severity_error = new EnumerationLiteral(this._Severity, "error", "Severity-error", "Severity-error");
...
export class Finding extends NodeBase {
    ...
    public constructor(classifier: Classifier, id: LionWebId, receiveDelta?: DeltaReceiver, parentInfo?: Parentage) {
        ...
        this._severity = new OptionalPropertyValueManager<Severity>(FindingBase.INSTANCE.Finding_severity, this);
        this._message = new OptionalPropertyValueManager<string>(FindingBase.INSTANCE.Finding_message, this);
