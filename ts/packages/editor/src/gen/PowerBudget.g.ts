...
export class PowerBudgetBase implements ILanguageBase {
    ...
    private ensureWiredUp() {
        ...
        this._PowerSourceKind.havingLiterals(this._PowerSourceKind_solar, this._PowerSourceKind_nuclear, this._PowerSourceKind_diesel);
        this._wiredUp = true;
    }
    ...
    factory(receiveDelta?: DeltaReceiver): NodeBaseFactory {
        return (classifier: Classifier, id: LionWebId) => {
            switch (classifier.key) {
                ...
                case this._PowerSource.key: return PowerSource.create(id, receiveDelta);
                default: {
